 ...
 * @return array
 */
function isodmeproxmox_ConfigOptions()
{
    return array(
        // a text field type allows for single line text input
        'CPU core count' => array(
            'Type' => 'text',
            'Size' => '2',
            'Default' => '1',
    	...
    	'RAM amount' => array(
            ...
            'Size' => '6',
            'Default' => '1',
            'Description' => 'Enter in MB of RAM',
        ),
    	'Disk Size' => array(
            'Type' => 'text',
            'Size' => '6',
            'Default' => '1',
            'Description' => 'Enter in GB of disk space',
        ),
        ...
        'Password Field' => array(
            ...
            'Size' => '64',
            'Default' => '',
            'Description' => 'Enter a password for the VPS control panel (Up to 64 Characters)',
        ),
 ...
 */
function isodmeproxmox_CreateAccount(array $params)
{
    try {
 ...
 * @return string "success" or an error message
 */
function isodmeproxmox_SuspendAccount(array $params)
{
    try {
 ...
 * @return string "success" or an error message
 */
function isodmeproxmox_UnsuspendAccount(array $params)
{
    try {
 ...
 * @return string "success" or an error message
 */
function isodmeproxmox_TerminateAccount(array $params)
{
    try {
...
/*function isodmeproxmox_ChangePassword(array $params)
{
    try {
 ...
 * @return string "success" or an error message
 */
function isodmeproxmox_ChangePackage(array $params)
{
    try {
        // Call the service's change password function, using the values
        // provided by WHMCS in `$params`.
 ...
 * @return array
 */
function isodmeproxmox_TestConnection(array $params)
{
    try {
...
/*
function isodmeproxmox_ClientAreaCustomButtonArray()
{
    return array(
...
function isodmeproxmox_buttonOneFunction(array $params)
{
    try {
 ...
 * @return string "success" or an error message
 */
function isodmeproxmox_actionOneFunction(array $params)
{
    try {
        // Call the service's function, using the values provided by WHMCS in
        // `$params`.
 ...
 * @return array
 */
function isodmeproxmox_AdminServicesTabFields(array $params)
{
    try {
        // Call the service's function, using the values provided by WHMCS in
        // `$params`.
 ...
 */
function isodmeproxmox_AdminServicesTabFieldsSave(array $params)
{
 ...
 * @return array
 */
function isodmeproxmox_ServiceSingleSignOn(array $params)
{
    try {
 ...
 * @return array
 */
function isodmeproxmox_AdminSingleSignOn(array $params)
{
    try {
 ...
 * @return array
 */
function isodmeproxmox_ClientArea(array $params)
{
